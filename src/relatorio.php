<?php
require_once 'conecta.php'; // carrega a conexão
$produtos = $pdo->query("SELECT * FROM produtos ORDER BY nome")->fetchAll(); // funcione e busca os dados lá
...
include_once 'header.php'; // carrega e disponibiliza
?>
